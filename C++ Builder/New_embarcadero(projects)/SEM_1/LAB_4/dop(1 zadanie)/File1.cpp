...
{  system ("chcp 1251>nul") ;
   ...
   int **mass = new int*[N]; // создание массива указателей
   for (int i = 0; i < N; i++)/*строки*/   //создание массивов одномерныХ, на которые указывают указатели
	  { mass[i] = new int [M]; /*колонки*/
   ...
   for (int i = 0; i < N /*строки*/; i++)
	   {
		 delete [] mass[i]; /* удаляем одномерные массивы , на которые указывают указатели*/
	   }


   delete [] mass; /* удаляем массив иуказателей*/
